...
/*Console.Clear();
Console.WriteLine($"Задача 4: Сформируйте трёхмерный массив из неповторяющихся двузначных чисел. Напишите программу, которая будет построчно выводить массив, добавляя индексы каждого элемента.");
...
/*Console.WriteLine($"Задача 5: Заполните спирально массив 4 на 4.");
